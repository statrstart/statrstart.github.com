...
axis(1,at=1:ncol(G2_2),labels=sub("/20","",colnames(G2_2)))
# text:位置調整
...
axis(1,at=1:ncol(G3),labels=sub("/20","",colnames(G3)))
...
axis(1,at=1:ncol(G4),labels=sub("/20","",colnames(G4)))
# text:位置調整
...
axis(1,at=1:ncol(G5),labels=sub("/20","",colnames(G5)))
# text:位置調整
...
axis(1,at=1:nrow(nCoV), labels =sub("2020-","",nCoV[,1] ))
