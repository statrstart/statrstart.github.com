...
|:------------|---------:|------:|--------------------:|
|Japan        |    13,231|    360|                 2.72|
|Korea, South |    10,728|    242|                 2.26|
|Taiwan*      |       429|      6|                 1.40|
|Hong Kong    |     1,037|      4|                 0.39|
|Singapore    |    12,693|     12|                 0.09|
...
```R
library(knitr)
date<- seq(as.Date("2020-02-01"), as.Date("2020-04-27"), by = "day")
...
感染者数<-c(12,15,15,16,18,23,24,24,25,27,28,28,28,28,28,29,30,31,46,82,156,346,556,763,893,1146,
	...
	10653,10661,10674,10683,10694,10702,10708,10718,10728,10738)
...
legend("topleft",inset=0.03,pch=16,lwd=2,cex=1,col=c("red","blue"),legend=c("日本","韓国"),bty="n")
title("日本と韓国のPCR検査の陽性率(%)の推移","Data : 日本(厚生労働省の報道発表資料) 韓国(KCDC)",cex.main=2)
#dev.off()
```
